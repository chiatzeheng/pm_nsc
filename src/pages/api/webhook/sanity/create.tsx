...
const handler = async (req: ExtendedNextApiRequest, res: NextApiResponse) => {
  // this is a webhook that will be called by sanity when a post or resource is published
  // it will then update all users to increment their announcement_count or resource_count
